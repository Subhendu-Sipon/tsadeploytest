...
export const Card = ({
  ...
  return (
    ...
    >
      <div className=" h-full w-full  overflow-hidden rounded-2xl bg-gradient-to-r from-stone-600 via-slate-500 to-stone-800 dark:bg-zinc-900 md:rounded-2xl md:p-4 ">
        {children}
      </div>
    </motion.div>
  );
