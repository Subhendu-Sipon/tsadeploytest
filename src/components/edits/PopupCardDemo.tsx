...
interface PopupCardDemoProps {
  imageSource: string;
  title: string;
  paragraph: string;
}

const PopupCardDemo: React.FC<PopupCardDemoProps> = ({
  imageSource,
  title,
  paragraph,
}) => {
    ...
    <div className="flex justify-center items-center h-auto">
      <div className="max-w-xs rounded overflow-hidden shadow-lg">
        ...
        <div className="px-6 py-4">
          <div className="font-bold text-xl mb-2 text-white animate-typing overflow-hidden whitespace-nowrap ">
            {title}
          </div>
